...
public class Robot extends TimedRobot {
  ...
  private  SpeedController m_frontLeft = new Talon(5);
  private SpeedController m_rearLeft = new Talon(6);
  private  SpeedControllerGroup m_left = new SpeedControllerGroup(m_frontLeft, m_rearLeft);
  
  private  SpeedController m_frontRight = new Talon(1);
  private  SpeedController m_rearRight = new Talon(8);
